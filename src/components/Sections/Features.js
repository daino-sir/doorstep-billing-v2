...
function Features() {
  return (
    ...
    <div className="max-w-2xl mx-auto mb-12 text-center">
            <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">What we do</h2>
            <p className="max-w-lg mx-auto mt-4 text-base leading-relaxed text-gray-600">Launch your campaign and benefit from our expertise on designing and managing conversion centered bootstrap4 html page.</p>
        </div>       
        <div className="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16">
            <div>
                ...
                <h3 className="mt-8 text-lg font-semibold text-black">Support</h3>
            ...
            <div>
                ...
                <h3 className="mt-8 text-lg font-semibold text-black">Sales</h3>
                <p className="mt-4 text-base text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
            </div>
            ...
            <div>
                ...
                <h3 className="mt-8 text-lg font-semibold text-black">Onboarding</h3>
                <p className="mt-4 text-base text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
            </div>
        </div>
    </div>
